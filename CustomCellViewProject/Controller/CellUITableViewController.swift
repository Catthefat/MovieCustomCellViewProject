//
//  CellUITableViewController.swift
...
class CellUITableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
       guard let cell = tableView.dequeueReusableCell(withIdentifier: "Cell", for: indexPath) as? MovieTableViewCell else {return UITableViewCell()}
        ...
        cell.TitleLabel?.text = movies.movie
        cell.GerneLabel?.text = "Gerne: \(movies.gerne)"
        cell.MovieYearLabel?.text = "Release Year: \(movies.year)"
